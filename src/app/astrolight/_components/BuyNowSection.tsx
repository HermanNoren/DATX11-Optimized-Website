...
export default function BuyNowSection() {
  return (
    <section className="w-full py-[5em] flex justify-center items-center">
      <div className="relative w-full h-[30em] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 bg-[#d9d9d9] w-full max-w-md p-[3em] text-center flex flex-col gap-[1.5em]">
